...
/*
    db.bounties.find({$and: [{species: {$eq: 'Groundhog'}}, {location: {$eq: 'Woodlands'}}]})
*/

// Update and Delete
// 1. Update the reward for Polarwind to 10000
/*
    db.bounties.updateOne({name: {$eq: 'Polarwind'}}, {$set: {reward: 10000}})
*/

// 2. Remove Lokinkajou
/*
    db.bounties.deleteOne({name: {$eq: 'Lokinkajou'}})
*/

// 3. Delete all bounties sent by Songbird
/*
    db.bounties.deleteMany({client: {$eq: 'Songbird'}})
*/
